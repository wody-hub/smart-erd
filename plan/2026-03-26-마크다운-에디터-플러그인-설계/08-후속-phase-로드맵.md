# 08. 후속 Phase 로드맵 (2026-04-02 최신화)
...
## Phase 6: Frontmatter 안전성 강화 ✅ (PR #6, 2026-04-02 완료)
...
## Phase 8: 허브 목록 성능 최적화 ✅ (PR #7, 2026-04-02 완료)
...
## Phase 9: 프리뷰 렌더링 최적화 (9-A ✅ PR #6 / 9-B 미착수)
...
1. **비동기 프리뷰 파이프라인** ✅ (PR #6, 2026-04-02 완료)
...
[Phase 1~5: 1차 구현 완료] ✅
        │
        ├── Phase 6: Frontmatter 안전성 ──────────────── ✅ PR #6
        │       │
        │       └── Phase 7: 증분 동기화 ──────── Phase 6 선행 완료, 착수 가능
        │               │
        │               └── Phase 9-B: 증분 프리뷰 ── Phase 7 선행 필요
        │
        ├── Phase 8: 허브 목록 최적화 ────────────────── ✅ PR #7
        │
        └── Phase 9-A: 비동기 Worker 프리뷰 ──────────── ✅ PR #6
```
...
|-------|------|----------|----------|------|
| **6** | Frontmatter 안전성 강화 | P1 (데이터 무결성) | 2~3일 | 없음 | ✅ PR #6 |
| **7** | 증분 동기화 (Section-Update) | P1 (협업 품질) | 1~2주 | Phase 6 ✅, `diff-match-patch` 설치 | 미착수 |
| **8** | 허브 목록 성능 최적화 | P2 (성능) | 2~3일 | 없음 | ✅ PR #7 |
| **9** | 프리뷰 렌더링 최적화 | P3 (UX) | 3~5일 | 9-A: 없음 / 9-B: Phase 7 | 9-A ✅ / 9-B 미착수 |

### 남은 작업 (2026-04-02 기준)

```text
Phase 7 (1~2주)  →  Phase 9-B 증분 프리뷰 (2~3일)
```

Phase 7(증분 동기화)이 유일한 대규모 남은 작업이며, 선행 조건(Phase 6)이 완료되어 즉시 착수 가능하다. Phase 9-B는 Phase 7 완료 후 진행한다.

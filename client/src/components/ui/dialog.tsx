...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ref={ref}
      className={cn(
        'dialog-overlay-scrim fixed inset-0 z-50 backdrop-blur-[3px] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
        className,
      )}
      {...props}
    />

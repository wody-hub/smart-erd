...
const useCanvasStore = create<CanvasState>((set, get) => ({
  ...
  internal: {
    ...
    hasDeferredProjectionSync: false,
    deferredProjectionForceFull: false,
    deferredProjectionTargets: new Set(),
    deferredProjectionNodeIds: new Set(),
    deferredProjectionEdgeIds: new Set(),
    deferredProjectionGroupIds: new Set(),

...
class AiChatDtoContractTest {
    ...
    @Test
    void requestAcceptsFrontendMessageContextAndSelectedResourceContract() {
        final var request = new AiChatRequest(
            ...
            null,
            new AiSelectedResourceRequest("PROJECT_ISSUE", 77L)
        );
        ...
        assertThat(command.selectedResource().id()).isEqualTo(77L);
    }
    ...
    void requestValidationUsesMessageKeysForBlankAndOversizedPrompt() {
        ...
        final var blankRequest = new AiChatRequest(" ", 1L, 10L, null, null, "ko", null, null, null);
        final var oversizedRequest = new AiChatRequest("x".repeat(4001), 1L, 10L, null, null, "ko", null, null, null);

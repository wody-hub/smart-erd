...
@Schema(description = "AI execution status response")
public record AiExecutionStatusResponse(
    ...
    public static AiExecutionStatusResponse from(AiExecutionGateway.AiExecutionView view) {
        return new AiExecutionStatusResponse(
            view.executionId(),
            view.provider(),
            view.promptVersion(),
            view.state().name(),

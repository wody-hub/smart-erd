 ...
 * 개인 TODO 수정 요청 DTO.
 */
@Schema(description = "개인 TODO 수정 요청")
public record UpdateProjectTodoRequest(
    ...
    @NotNull(message = "{validation.not-null.todo-status}")
    ProjectTodoStatus status,

    @Schema(description = "TODO 우선순위", example = "HIGH")
    @NotNull(message = "{validation.not-null.todo-priority}")

...
/**
 * 프로젝트 인력 투입 수정 요청 DTO.
 */
@Schema(description = "프로젝트 인력 투입 수정 요청")
public record UpdateProjectStaffingRequest(
    @Schema(description = "인력 등급", example = "SENIOR")
    @NotNull(message = "{validation.not-null.staffing-grade}")
    StaffingGrade grade,

    @Schema(description = "월 단가(KRW)", example = "13000000")

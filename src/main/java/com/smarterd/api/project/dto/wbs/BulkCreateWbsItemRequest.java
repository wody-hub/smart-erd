...
public record BulkCreateWbsItemRequest(
    @NotBlank @Size(max = 64) @Schema(description = "배치 내부 stable key", example = "task-api-design") String clientKey,
    @Nullable @Schema(description = "기존 부모 WBS ID", example = "100") Long parentId,
    @Nullable @Size(max = 64) @Schema(description = "같은 요청 내 부모 clientKey", example = "phase-analysis") String parentClientKey,
    ...
    @Nullable @Min(0) @Max(100) @Schema(description = "진척률", example = "0") Integer progressRate,
    @Nullable @DecimalMin("0.0") @Schema(description = "예상 M/M", example = "1.25") BigDecimal estimatedMm,

...
public class ProjectController {
    ...
    @ApiResponse(responseCode = "201", description = "프로젝트 생성 성공", content = @Content(schema = @Schema(implementation = ProjectResponse.class)))
    ...
    public ResponseEntity<ProjectResponse> createProject(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(projectService.createProject(jwt.getSubject(), teamId, request));
    }

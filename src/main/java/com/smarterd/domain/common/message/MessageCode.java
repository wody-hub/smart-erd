...
public enum MessageCode {
    ...
    ERROR_BUSINESS_AI_CHAT_SCOPE_REQUIRED("error.business.ai-chat.scope-required"),
    ERROR_BUSINESS_AI_CHAT_PROJECT_AMBIGUOUS("error.business.ai-chat.project-ambiguous"),
    ERROR_BUSINESS_AI_CHAT_PROJECT_FUZZY_CONFIRMATION("error.business.ai-chat.project-fuzzy-confirmation"),
    ERROR_BUSINESS_AI_CHAT_PROJECT_CONFLICTING("error.business.ai-chat.project-conflicting"),
    ERROR_BUSINESS_AI_CHAT_TOO_MANY_PROJECTS("error.business.ai-chat.too-many-projects"),

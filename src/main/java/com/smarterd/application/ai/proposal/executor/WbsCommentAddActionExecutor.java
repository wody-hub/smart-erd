...
/**
 * Executes approved WBS comment append proposals.
 */
@Component
public class WbsCommentAddActionExecutor implements AiActionExecutor {

    public static final String ACTION_TYPE = "wbs.comment.add";
    ...
    public WbsCommentAddActionExecutor(
